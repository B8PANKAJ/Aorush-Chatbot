...
const Bot = () => {
  ...
  const handleInput = () => {
    ...
    if (words8.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "My name is AORUSH";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
        ...
        <div className="wrapper">
          <div className="content">
            <div className="header">
              <div className="img">
                <img
                  src="https://plus.unsplash.com/premium_photo-1682023585717-5cb1fad1b141?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8cm9ib3R8ZW58MHx8MHx8fDA%3D"
                  alt=""
                />
              </div>
              <div className="right">
                <div className="name">AORUSH</div>
